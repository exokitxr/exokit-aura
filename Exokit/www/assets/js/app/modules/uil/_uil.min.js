...
UIL.Knob.prototype.update=function(a){this.c[2].textContent=this.value;this.percent=(this.value-this.min)/this.range;UIL.setSvg(this.c[4],"transform","rotate("+(this.percent*this.cirRange-this.mPI)*this.toDeg+" "+this.radius+" "+this.radius+")");a&&this.send()};UIL.Joystick=function(a){UIL.Proto.call(this,a);this.autoWidth=!1;this.value=[0,0];this.precision=a.precision||2;this.multiplicator=a.multiplicator||1;this.oldy=this.oldx=this.y=this.x=0;this.interval=null;this.radius=a.radius||50;this.width=2*this.radius+20;void 0!==a.width&&(this.width=a.width,this.radius=0.5*~~(this.width-20));void 0!==a.size&&(this.width=a.size,this.radius=0.5*~~(this.width-20));this.innerRadius=a.innerRadius||0.6*this.radius;this.maxDistance=this.radius-this.innerRadius-5;this.height=
    2*this.radius;this.h=a.height||this.height+40;this.top=0;this.c[0].style.width=this.width+"px";void 0!==this.c[1]&&(this.c[1].style.width=this.width+"px",this.c[1].style.textAlign="center",this.top=20);this.c[2]=UIL.DOM(null,"circle",UIL.BASIC+"left:10px; top:"+this.top+"px; width:"+this.w+"px; height:"+this.height+"px;  pointer-events:auto; cursor:pointer;",{cx:this.radius,cy:this.radius,r:this.radius,fill:"url(#grad)"});this.c[3]=UIL.DOM(null,"circle",UIL.BASIC+"left:0px; top:"+(this.top-10)+"px; width:"+
    (this.w+20)+"px; height:"+(this.height+20)+"px;",{cx:this.radius+10,cy:this.radius+10,r:this.innerRadius+10,fill:"url(#gradS)"});this.c[4]=UIL.DOM(null,"circle",UIL.BASIC+"left:10px; top:"+this.top+"px; width:"+this.w+"px; height:"+this.height+"px;",{cx:this.radius,cy:this.radius,r:this.innerRadius,fill:"url(#gradIn)","stroke-width":1,stroke:"#000"});this.c[5]=UIL.DOM(null,"div",UIL.TXT+"text-align:center; top:"+(this.height+20)+"px; width:"+this.width+"px; color:"+this.fontColor);a=this.c[2];UIL.DOM(null,
    "defs",null,{},a);UIL.DOM(null,"radialGradient",null,{id:"grad",cx:"50%",cy:"50%",r:"50%",fx:"50%",fy:"50%"},a,1);UIL.DOM(null,"stop",null,{offset:"40%",style:"stop-color:rgb(0,0,0); stop-opacity:0.3;"},a,[1,0]);UIL.DOM(null,"stop",null,{offset:"80%",style:"stop-color:rgb(0,0,0); stop-opacity:0;"},a,[1,0]);UIL.DOM(null,"stop",null,{offset:"90%",style:"stop-color:rgb(50,50,50); stop-opacity:0.4;"},a,[1,0]);UIL.DOM(null,"stop",null,{offset:"100%",style:"stop-color:rgb(50,50,50); stop-opacity:0;"},a,
    [1,0]);a=this.c[3];UIL.DOM(null,"defs",null,{},a);UIL.DOM(null,"radialGradient",null,{id:"gradS",cx:"50%",cy:"50%",r:"50%",fx:"50%",fy:"50%"},a,1);UIL.DOM(null,"stop",null,{offset:"60%",style:"stop-color:rgb(0,0,0); stop-opacity:0.5;"},a,[1,0]);UIL.DOM(null,"stop",null,{offset:"100%",style:"stop-color:rgb(0,0,0); stop-opacity:0;"},a,[1,0]);a=this.c[4];UIL.DOM(null,"defs",null,{},a);UIL.DOM(null,"radialGradient",null,{id:"gradIn",cx:"50%",cy:"50%",r:"50%",fx:"50%",fy:"50%"},a,1);UIL.DOM(null,"stop",
    null,{offset:"30%",style:"stop-color:rgb(40,40,40); stop-opacity:1;"},a,[1,0]);UIL.DOM(null,"stop",null,{offset:"60%",style:"stop-color:rgb(48,48,48); stop-opacity:1;"},a,[1,0]);UIL.DOM(null,"stop",null,{offset:"80%",style:"stop-color:rgb(48,48,48); stop-opacity:1;"},a,[1,0]);UIL.DOM(null,"stop",null,{offset:"100%",style:"stop-color:rgb(30,30,30); stop-opacity:1;"},a,[1,0]);UIL.DOM(null,"radialGradient",null,{id:"gradIn2",cx:"50%",cy:"50%",r:"50%",fx:"50%",fy:"50%"},this.c[4],1);UIL.DOM(null,"stop",
    null,{offset:"30%",style:"stop-color:rgb(1,90,197); stop-opacity:1;"},a,[1,1]);UIL.DOM(null,"stop",null,{offset:"60%",style:"stop-color:rgb(3,95,207); stop-opacity:1;"},a,[1,1]);UIL.DOM(null,"stop",null,{offset:"80%",style:"stop-color:rgb(3,95,207); stop-opacity:1;"},a,[1,1]);UIL.DOM(null,"stop",null,{offset:"100%",style:"stop-color:rgb(0,65,167); stop-opacity:1;"},a,[1,1]);this.c[5].textContent="x"+this.value[0]+" y"+this.value[1];this.c[2].events=["mouseover","mousedown","mouseout"];this.init();
    this.update(!1)};UIL.Joystick.prototype=Object.create(UIL.Proto.prototype);UIL.Joystick.prototype.constructor=UIL.Joystick;UIL.Joystick.prototype.handleEvent=function(a){a.preventDefault();switch(a.type){case "mouseover":this.over(a);break;case "mousedown":this.down(a);break;case "mouseout":this.out(a);break;case "mouseup":this.up(a);break;case "mousemove":this.move(a)}};
