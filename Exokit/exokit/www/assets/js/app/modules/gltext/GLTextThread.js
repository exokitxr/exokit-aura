Class(function GLTextUtils() {
    ...
    function loadTextGeometry({font, text, width, align, size, letterSpacing, lineHeight, wordSpacing, wordBreak, json, glyphs}, pid) {
        const newline = /\n/;
        const whitespace = /\s/;
        ...
        function populateBuffers(lines) {
            ...
            for (let lineIndex = 0; lineIndex < lines.length; lineIndex++) {
                ...
                for (let i = 0; i < line.glyphs.length; i++) {
                    ...
                    buffers.id.set([glyphIndex, glyphIndex, glyphIndex, glyphIndex], glyphIndex * 4);
                    glyphIndex++;
            ...
            if (geom) buffers.boundingBox = geom.boundingBox;
