...
class GLPropertyBindings {
    ...
    init(gl: JSValue!) {
        ...
        gl.setValue(GL_COLOR_ATTACHMENT1, forProperty: "COLOR_ATTACHMENT1");
        gl.setValue(GL_COLOR_ATTACHMENT2, forProperty: "COLOR_ATTACHMENT2");
        gl.setValue(GL_COLOR_ATTACHMENT3, forProperty: "COLOR_ATTACHMENT3");
        gl.setValue(GL_COLOR_ATTACHMENT4, forProperty: "COLOR_ATTACHMENT4");
        gl.setValue(GL_COLOR_ATTACHMENT5, forProperty: "COLOR_ATTACHMENT5");
        gl.setValue(GL_COLOR_ATTACHMENT6, forProperty: "COLOR_ATTACHMENT6");
        gl.setValue(GL_COLOR_ATTACHMENT7, forProperty: "COLOR_ATTACHMENT7");
        gl.setValue(GL_COLOR_ATTACHMENT8, forProperty: "COLOR_ATTACHMENT8");
        gl.setValue(GL_COLOR_ATTACHMENT9, forProperty: "COLOR_ATTACHMENT9");
        gl.setValue(GL_COLOR_ATTACHMENT10, forProperty: "COLOR_ATTACHMENT10");
        gl.setValue(GL_COLOR_ATTACHMENT11, forProperty: "COLOR_ATTACHMENT11");
        gl.setValue(GL_COLOR_ATTACHMENT12, forProperty: "COLOR_ATTACHMENT12");
        gl.setValue(GL_COLOR_ATTACHMENT13, forProperty: "COLOR_ATTACHMENT13");
        gl.setValue(GL_COLOR_ATTACHMENT14, forProperty: "COLOR_ATTACHMENT14");
        gl.setValue(GL_COLOR_ATTACHMENT15, forProperty: "COLOR_ATTACHMENT15");
        ...
        gl.setValue(GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG, forProperty: "GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG");
        gl.setValue(GL_TEXTURE_MAX_ANISOTROPY_EXT, forProperty: "GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG");
        gl.setValue(GL_TEXTURE_MAX_ANISOTROPY_EXT, forProperty: "GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG");
        gl.setValue(GL_TEXTURE_MAX_ANISOTROPY_EXT, forProperty: "GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG");
        gl.setValue(GL_DRAW_BUFFER0, forProperty: "DRAW_BUFFER0");
        gl.setValue(GL_DRAW_BUFFER1, forProperty: "DRAW_BUFFER1");
        gl.setValue(GL_DRAW_BUFFER2, forProperty: "DRAW_BUFFER2");
        gl.setValue(GL_DRAW_BUFFER3, forProperty: "DRAW_BUFFER3");
        gl.setValue(GL_DRAW_BUFFER4, forProperty: "DRAW_BUFFER4");
        gl.setValue(GL_DRAW_BUFFER5, forProperty: "DRAW_BUFFER5");
        gl.setValue(GL_DRAW_BUFFER6, forProperty: "DRAW_BUFFER6");
        gl.setValue(GL_DRAW_BUFFER7, forProperty: "DRAW_BUFFER7");
        gl.setValue(GL_DRAW_BUFFER8, forProperty: "DRAW_BUFFER8");
        gl.setValue(GL_DRAW_BUFFER9, forProperty: "DRAW_BUFFER9");
        gl.setValue(GL_DRAW_BUFFER10, forProperty: "DRAW_BUFFER10");
        gl.setValue(GL_DRAW_BUFFER11, forProperty: "DRAW_BUFFER11");
        gl.setValue(GL_DRAW_BUFFER12, forProperty: "DRAW_BUFFER12");
